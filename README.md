...
<ul>
  ...
  <li>Classification token is handled differently in all methods. Check below for more details. <a href="splitting-x-and-y-axis-to-multiple-1d-positonal-embeddings">below</a></li>
