...
Relative Positional Embedding uses a "max_relative_distance" hyper-parameter and is used to clamp distances between -max_relative_distance and max_relative_distance.
<br>
